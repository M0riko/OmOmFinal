  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-3xl py-8">
        ...
        >
          <h1 className="text-3xl font-bold mb-6">Умови використання SLKY</h1>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Використовуючи додаток SLKY (далі - "Додаток"), ви погоджуєтеся з цими Умовами використання. 
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              SLKY - це платформа для відстеження харчування, активності та води, а також для отримання консультацій від віртуальних тренерів. 
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Додаток SLKY - це не медичний сервіс. Всі поради від віртуальних тренерів та розрахунки калорій мають рекомендаційний характер. 
